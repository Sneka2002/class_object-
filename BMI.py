...
Button(left_view1,text='CALCULATE 📲',font=('algerian',15,'bold'),command=bmi_calculation, width=13,bg='silver').place(relx=0.7, rely=0.1)
Button(left_view1,text='DELETE 🧿',font=('algerian',15,'bold'),command=delete_record, width=13,bg='silver').place(relx=0.7, rely=0.3)
Button(left_view1,text='CLEAR 🥏',font=('algerian',15,'bold'),command=clear_records, width=13,bg='silver').place(relx=0.7, rely=0.5)
Button(left_view1,text='VIEW RECORD 💾',font=('algerian',15,'bold'),command=view_record, width=13,bg='silver').place(relx=0.7, rely=0.7)
